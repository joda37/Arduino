...
///
/// @brief Espressif ESP32-DevKitC pcb version
/// @note Numbers refer to GPIOs not pins
///
const pins_t boardESP32DevKitC =
        {
                .panelBusy = 15, ///< EXT3 pin 3 Red -> GPIO27
                .panelDC = 2, ///< EXT3 pin 4 Orange -> GPIO26
                .panelReset = 4, ///< EXT3 pin 5 Yellow -> GPIO25
                .flashCS = 5, ///< EXT3 pin 8 Violet -> GPIO33
                .panelCS = 21, ///< EXT3 pin 9 Grey -> GPIO32

                //Not needed for this ESP32DevkitC
...
///
/// @brief Espressif ESP32-DevKitC version one that worked before pcb
/// @note Numbers refer to GPIOs not pins
///
/*const pins_t boardESP32DevKitC =
{
    .panelBusy = 14, ///< EXT3 pin 3 Red -> GPIO27
    .panelDC = 27, ///< EXT3 pin 4 Orange -> GPIO26
    .panelReset = 26, ///< EXT3 pin 5 Yellow -> GPIO25
    .flashCS =25, ///< EXT3 pin 8 Violet -> GPIO33
    .panelCS = 33, ///< EXT3 pin 9 Grey -> GPIO32
